...
export const createdCart = (cart) => API.post('carts', cart)
export const updatedCart = (id, updatedCart) => API.patch(`/carts/${id}`, updatedCart)
export const deletedCart = (id) => API.delete(`/carts/${id}`)
